...
description: "Writing text for an AI to read? Use this skill. Applies to: commands, hooks, skills, system prompts, agent prompts, LLM API calls, instruction templates, AI-facing docs, RAG prompts, few-shot examples. If an LLM will read it, invoke this."
---
